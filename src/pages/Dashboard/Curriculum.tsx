...
export default function CurriculumForm() {
  ...
  useEffect(() => {
    setIsLoading(true)
    fetch(`${BASE_URL}/API/getCurriculum`, {headers})
      .then((res) => res.json())
  ...
  const handleSubmit = () => {
    ...
    const url = `${BASE_URL}/API/setCurriculumStatus`
    fetch(url, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json', 
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-3xl font-bold text-center text-gray-900 mb-8">Curriculum Form</h1>
