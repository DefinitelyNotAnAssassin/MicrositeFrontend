...
<div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center">{program.programAbbreviation} Student Concerns</CardTitle>
            <CardDescription className="text-center">
              Have a concern about the {program.programName} program? Let us know!
            </CardDescription>
          </CardHeader>
          <CardContent>
