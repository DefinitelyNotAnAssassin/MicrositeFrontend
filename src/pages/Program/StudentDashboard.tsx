...
export default function StudentDashboard() {
  ...
  const calculateAnalytics = (studentData: Student) => {
    ...
    const incomplete = courseStatuses.filter(status => status === 'incomplete').length
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  <h3 className="text-lg font-semibold mb-2">Incomplete Subjects</h3>
                  <p className="text-3xl font-bold text-yellow-600">{analytics.totalIncomplete}</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
